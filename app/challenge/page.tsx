      ...
      <main className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <div className="text-center flex flex-col items-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-teal-500/20 bg-teal-50/50 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-teal-700 dark:border-teal-500/20 dark:bg-teal-500/10 dark:text-teal-400">
            Cryptography Lab & Question Bank
          </div>
          <h1 className="flex items-center justify-center gap-3 text-3xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-4xl">
            ...
            Cryptography Challenge & Question Bank
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
            Practice over 300 curated questions across classical, symmetric, asymmetric, hash primitives, and security attacks, or decrypt ciphertext against the clock.
          </p>
        </div>
        ...
        {/* Question Bank 300+ Multiple Choice Quiz Section */}
        <div>
          <QuestionBankQuiz />
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-zinc-50 px-4 text-sm text-zinc-500 dark:bg-zinc-950 dark:text-zinc-400">Or practice timed interactive decryption</span>
          </div>
        </div>

        {/* Interactive Decryption Challenge Component */}
        <ChallengeMode />
      </main>
    </WorkspaceLayout>
  );
